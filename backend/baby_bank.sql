...
-- Schema baby_bank
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `baby_bank` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `baby_bank`.`tb_user` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `baby_bank`.`tb_origin` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `baby_bank`.`tb_income` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `baby_bank`.`tb_savings` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `baby_bank`.`tb_category` ;
...
CREATE TABLE IF NOT EXISTS `baby_bank`.`tb_category` (
  ...
  `idUser` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_tb_category_tb_user1_idx` (`idUser` ASC),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `baby_bank`.`tb_expenses` ;
